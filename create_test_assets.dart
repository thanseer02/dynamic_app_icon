...
void main() {
  ...
  final img1 = img.Image(width: 1024, height: 1024);
  ...
  final img2 = img.Image(width: 1024, height: 1024);
  ...
  final img3 = img.Image(width: 1024, height: 1024);
  ...
  print('Created test 1024x1024 asset images in example/assets/app_icons/');
}
