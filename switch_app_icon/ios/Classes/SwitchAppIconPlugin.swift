...
public class SwitchAppIconPlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "switch_app_icon", binaryMessenger: registrar.messenger())
    let instance = SwitchAppIconPlugin()
